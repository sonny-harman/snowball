...
envelope_comp = [0.999, 0.001, 0. ,0., 0.]  #surface mixing ratios - must sum to 1
envelope_species= ['H2', 'He', 'O', 'H2O', 'O2'] #component molecular masses [amu]
envelope_compm= [2., 4., 16., 18., 32] #component molecular masses [amu]
envelope_compH= [1, 0., 0., 2/3, 0.] #fraction of atoms that are H in each species
...
hnu = 1.03E-18 #J, equivalent of 4.6 eV (~270 nm) (Owen & Alvarez, 2016); mean XUV photon energy that is responsible for heating the atmosphere
