...
for j in range(len(start)):
      ...
      for i in range(start[j],end[j],step[j]):
            ...
            Mp_p2e, flux1, flux2 = calc_escape_regime(eta_t[-1],m_p_kg,r_p_m,T_exo,mu_t[-1])
            ...
            #      print(age[i],regime_t[-1],eta_t[-1],m_p_kg,r_p_m,mu_t[-1],vmr_t[-1])
            #else:
            #      print('nah -- ',regime_t[-1],eta_t[-1],m_p_kg,r_p_m,mu_t[-1],vmr_t[-1])
